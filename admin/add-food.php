...
<div class="main-content">
    <div class="wrapper form-container">
        <h1 class="form-title">Add Food</h1>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <table class="tbl-30">
                <tr>
                    <td>Tên Món Ăn: </td>
                    <td>
                        <input type="text" name="title" placeholder="Tên của món ăn" class="input-field">
                    </td>
                </tr>
                ...
                <tr>
                    <td>Mô Tả: </td>
                    <td>
                        <textarea name="description" cols="30" rows="5" placeholder="Mô tả món ăn." class="input-field"></textarea>
                    </td>
                </tr>
