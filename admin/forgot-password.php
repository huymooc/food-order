...
<html>
    <head>
        <title>Forgot Password - Meowbee Food Admin</title>
    ...
    <div class="login-container">
        <div class="login">
            ...
            <a href="login.php"><img src="../images/meowbee.png" alt="Logo" class="login-logo"></a>
            <br><br>
...
if(isset($_POST['submit']))
{
    ...
    if(mysqli_num_rows($res) == 1) {
        ...
        $sql2 = "UPDATE tbl_admin SET password='$hashed_password' WHERE username='$username' AND email='$email'";
        ...
        if($res2 == true) {
            ...
            try {
                ...
                // Cấu hình email
                $mail->setFrom('anhhuy482003@gmail.com', 'Meowbee Food Admin');
                $mail->addAddress($email); // Email người nhận
                $mail->Subject = 'Reset Password - Meowbee Food Admin';
    ...
    header('location:'.SITEURL.'admin/forgot-password.php');
}
?>